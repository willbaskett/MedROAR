...
class RotaryEmbedding(Module):
    ...
    def rotate_queries_or_keys(self, t, seq_dim = None, offset = 0, freq_seq_len = None, seq_order=None):
        ...
        if seq_order is None:
            ...
            freqs = self.forward((seq_order+offset) / self.interpolate_factor, seq_len = seq_len, offset = offset)
    ...
    def forward(
        ...
        if (
            ...
            (offset + seq_len) < self.cached_freqs.shape[2]
        ):
            #print("USED CACHE")
